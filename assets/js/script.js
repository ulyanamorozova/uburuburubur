...
$('.scene__projector').click(function () {
    ...
    if (projectorIndex === enabledProjectorIndex) {
        ...
        $('.scene__light').attr('src', 'assets/img/light_projector_' + enabledProjectorIndex + '.png').css('display', 'block');
...
function setBottomObjectRandomDots() {
    for (var i = 1; i <= dotsCount; i++) {
        ...
        $('.bottom__object-wrapper')
            .append('<img id="dot_' + i + '" src="assets/img/dot_' + i + '.png" alt="Точка" class="dot" style="left: ' + left + 'px;top: ' + top + 'px;">');
    }
}